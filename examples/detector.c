...
//void validate_detector_recall(char *datacfg, char *cfgfile, char *weightfile)
{
    ...
    list *plist=get_paths("/home/gaohan/Project/darknet/scripts/2012_val.txt");
    char **paths = (char **)list_to_array(plist);
    /*list *options = read_data_cfg(datacfg);
    char *valid_images = option_find_str(options, "valid", "data/train.list");
    list *plist = get_paths(valid_images);
...
/*#ifdef OPENCV
            ...
            int m = plist->size;
            if(access("/home/gaohan/Project/darknet/data/out",0)==-1)//"/home/FENGsl/darknet/data"修改成自己的路径
            {
              if (mkdir("/home/gaohan/Project/darknet/data/out",0777))//"/home/FENGsl/darknet/data"修改成自己的路径
               {
        ...
        if(outfile){
            save_image(im, outfile);
             ...
             char b[2048];
            sprintf(b,"/home/gaohan/Project/darknet/data/out/%s",GetFilename(path));//"/home/FENGsl/darknet/data"修改成自己的路径
